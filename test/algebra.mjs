...
import { Scalar, buildBn128, F1Field } from '../dist/main.js';

test("F1 testing", async function() {

    let bn128 = await buildBn128();
    await it("Should compute euclidean", () => {
    ...
    await it("Should multiply and divide in F1", () => {
    ...
    await it("Should compute sqrt of 100 random numbers", () => {
        const F = new F1Field(bn128.r);
        for (let j=0;j<100; j++) {
            let a = F.random();
            let s = F.sqrt(a);
...
test("Curve G1 Test", async function() {
    ...
    await it("Should add match in various in G1", () => {
...
test("Curve G2 Test", async function() {
    ...
    await it("Should add match in various in G2", () => {
        const r1 = bn128.Fr.e(33);
        const r2 = bn128.Fr.e(44);
...
test("F6 testing", async function() {


    let bn128 = await buildBn128();

    await it("Should multiply and divide in F6", () => {
...
test("F12 testing", async function() {


    let bn128 = await buildBn128();

    await it("Should multiply and divide in F12", () => {
...
test("Pairing", async function() {


    let bn128 = await buildBn128();

    /*
    await it("Should match pairing", () => {
        for (let i=0; i<1; i++) {
    ...
    */
    await it("Should generate another pairing pairing", () => {
        for (let i=0; i<1; i++) {
...
test("Compressed Form", async function() {


    let bn128 = await buildBn128();

    await it("Should test rpr of G2", () => {
